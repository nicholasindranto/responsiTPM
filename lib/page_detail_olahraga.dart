...
class PageDetailOlahraga extends StatefulWidget {
  final String link;
  const PageDetailOlahraga({Key? key, required this.link}) : super(key: key);

  @override
  State<PageDetailOlahraga> createState() => _PageDetailOlahragaState();
}

class _PageDetailOlahragaState extends State<PageDetailOlahraga> {
  @override
