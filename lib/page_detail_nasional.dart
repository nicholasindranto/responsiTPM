...
class PageDetailNasional extends StatefulWidget {
  final String link;
  const PageDetailNasional({Key? key, required this.link}) : super(key: key);

  @override
  State<PageDetailNasional> createState() => _PageDetailNasionalState();
}

class _PageDetailNasionalState extends State<PageDetailNasional> {
  @override
